...
export const HiddenButtonsButton = ({hiddenChipsetsButtons}: HiddenButtonsButtonType) => {
	const { hiddenChipsetsButton } = defaultState;
	const buttons = hiddenChipsetsButtons.map(item => <ChipsetWrap><ChipsetButton key={item} buttonName={item}/></ChipsetWrap>)
